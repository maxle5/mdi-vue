  ...
  export default defineComponent({
      name: "MdiCloudCheckVariantOutline",
      props: {
          size: { 
              type: Number, 
              default: 24 
