...
<script lang="ts">
  ...
  export default defineComponent({
      name: "MdiCloudRefreshVariantOutline",
      props: {
          size: { 
              type: Number, 
              default: 24 
