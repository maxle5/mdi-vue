  ...
  export default defineComponent({
      name: "MdiStorefrontCheckOutline",
      props: {
          size: { 
              type: Number, 
              default: 24 
