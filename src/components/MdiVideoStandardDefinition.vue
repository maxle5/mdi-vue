...
<script lang="ts">
  ...
  export default defineComponent({
      name: "MdiVideoStandardDefinition",
      props: {
          size: { 
              type: Number, 
              default: 24 
