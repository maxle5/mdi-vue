  ...
  export default defineComponent({
      name: "MdiRadioboxIndeterminateVariant",
      props: {
          size: { 
              type: Number, 
              default: 24 
