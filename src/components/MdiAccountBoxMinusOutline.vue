...
<script lang="ts">
  ...
  export default defineComponent({
      name: "MdiAccountBoxMinusOutline",
      props: {
          size: { 
              type: Number, 
              default: 24 
