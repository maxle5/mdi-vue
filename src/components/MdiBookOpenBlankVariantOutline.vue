...
<script lang="ts">
  ...
  export default defineComponent({
      name: "MdiBookOpenBlankVariantOutline",
      props: {
          size: { 
              type: Number, 
              default: 24 
