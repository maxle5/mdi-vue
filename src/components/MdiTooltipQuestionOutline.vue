...
<script lang="ts">
  ...
  export default defineComponent({
      name: "MdiTooltipQuestionOutline",
      props: {
          size: { 
              type: Number, 
              default: 24 
