...
<script lang="ts">
  ...
  export default defineComponent({
      name: "MdiImageFilterDramaOutline",
      props: {
          size: { 
              type: Number, 
              default: 24 
